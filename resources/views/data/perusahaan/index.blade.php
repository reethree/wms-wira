...
<script>
    function gridCompleteEvent()
    {
        ...
        for(var i=0;i < ids.length;i++){ 
            ...
            del = '<a href="{{ route("perusahaan-delete",'') }}/'+dataid+'" onclick="if (confirm(\'Are You Sure ?\')){return true; }else{return false; };"><i class="fa fa-close"></i></a>';
...
<!--        <div class="box-tools">
    ...
    <div class="box-body table-responsive">
            {{
                ...
                ->setGridOption('editurl',URL::to('/perusahaan/crud'))
