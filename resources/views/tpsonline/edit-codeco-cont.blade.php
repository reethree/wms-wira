            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="REF_NUMBER" class="form-control" value="{{ $detail->REF_NUMBER }}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group date">
                                ...
                                <input type="text" name="TGL_ENTRY" class="form-control pull-right datepicker" value="{{ date('Y-m-d',strtotime($detail->TGL_ENTRY)) }}">
                            </div>
                        </div>
                    </div>                  
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group date">
                                ...
                                <input type="text" name="TGL_TIBA" class="form-control pull-right datepicker" value="{{ date('Y-m-d',strtotime($detail->TGL_TIBA)) }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="NO_SEEGEL" class="form-control"  value="{{ $detail->NO_SEGEL }}">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group date">
                                ...
                                <input type="text" name="TGL_MASTER_BL_AWB" class="form-control pull-right datepicker" value="{{ date('Y-m-d',strtotime($detail->TGL_MASTER_BL_AWB)) }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group date">
                                ...
                                <input type="text" name="TGL_BL_AWB" class="form-control pull-right datepicker" value="{{ date('Y-m-d',strtotime($detail->TGL_BL_AWB)) }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group date">
                                ...
                                <input type="text" name="TGL_BC11" class="form-control pull-right datepicker" value="{{ date('Y-m-d',strtotime($detail->TGL_BC11)) }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group date">
                                ...
                                <input type="text" name="TGL_DOK_INOUT" class="form-control pull-right datepicker" value="{{ date('Y-m-d',strtotime($detail->TGL_DOK_INOUT)) }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group date">
                                ...
                                <input type="text" name="TGL_DAFTAR_PABEAN" class="form-control pull-right datepicker" value="{{ date('Y-m-d',strtotime($detail->TGL_DAFTAR_PABEAN)) }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group date">
                                ...
                                <input type="text" name="TGL_SEGEL_BC" class="form-control pull-right datepicker" value="{{ date('Y-m-d',strtotime($detail->TGL_SEGEL_BC)) }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group date">
                                ...
                                <input type="text" name="TGL_IJIN_TPS" class="form-control pull-right datepicker" value="{{ date('Y-m-d',strtotime($detail->TGL_IJIN_TPS)) }}">
                            </div>
                        </div>
                    </div>
                </div>
