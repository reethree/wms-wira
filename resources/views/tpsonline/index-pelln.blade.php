...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">Pelabuhan LN</h3>
<!--        <div class="box-tools">
    ...
    <div class="box-body table-responsive">
            {{
                GridRender::setGridId("tpsPelLnGrid")
                ->enableFilterToolbar()
                ->setGridOption('url', URL::to('/tpsonline/pelabuhanln/grid-data'))
                ->setGridOption('editurl',URL::to('/tpsonline/pelabuhanln/crud'))
                ->setGridOption('rowNum', 20)
                ->setGridOption('shrinkToFit', true)
                ->setGridOption('sortname','TPSPELLNXML_PK')
                ...
                ->addColumn(array('key'=>true,'index'=>'TPSPELLNXML_PK','hidden'=>true))
